...
2. **RFI List (before pricing)** — every discrepancy/absence phrased as a submittable RFI. New `finding_type: "rfi"` permitted from specialists and generated by the reconciler from discrepancy findings.
